      ...
      <y-navigation-drawer class="bottom-0 h-auto sticky top-[64px]" open>
        ...
        >
          <y-dropdown-drawer-item
            class="gap-1"
            prefix="yi yi-minus"
            @click="$router.push('/home/email/konu1mail')"
          >
            <router-link
              class="p-2 m-0.5 border-2 rounded-lg"
              active-class="active-svg bg-white border-blue-500 "
              :to="{ name: 'konu1' }"
              >Konu1</router-link
            >
          </y-dropdown-drawer-item>
          <y-dropdown-drawer-item
            ...
            @click="$router.push('/home/email/konu2mail')"
          >
            Konu2
          </y-dropdown-drawer-item>
        </y-dropdown-drawer>
